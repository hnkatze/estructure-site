  ...
  const handlePush = () => {
    if (!newValue.trim()) {
      toast({
        ...
        description: "Por favor ingresa un valor para añadir a la pila",
        variant: "destructive",
      })
      return
    }
    ...
    if (stack.length >= maxSize) {
      toast({
        ...
        description: "La pila ha alcanzado su capacidad máxima",
        variant: "destructive",
      })
      return
    }
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `Se añadió "${newValue}" al tope de la pila`,
      })
    }, 800)
  }
  ...
  const handlePop = () => {
    if (stack.length === 0) {
      toast({
        ...
        description: "No se puede hacer pop en una pila vacía",
        variant: "destructive",
      })
      return
    }
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Pop completado",
        description: `Se eliminó "${poppedValue}" del tope de la pila`,
      })
    }, 800)
  }
