...
export default function QueueVisualization({
  ...
  const handleEnqueue = () => {
    if (!newValue.trim()) {
      toast({
        ...
        description: "Por favor ingresa un valor para añadir a la fila",
        variant: "destructive",
      })
      return
    }
    ...
    if (queue.length >= maxSize) {
      toast({
        title: "Fila llena",
        description: "La fila ha alcanzado su capacidad máxima",
        variant: "destructive",
      })
      return
    }
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Enqueue completado",
        description: `Se añadió "${newValue}" al final de la fila`,
      })
    }, 800)
  }
  ...
  const handleDequeue = () => {
    if (queue.length === 0) {
      toast({
        title: "Fila vacía",
        description: "No se puede hacer dequeue en una fila vacía",
        variant: "destructive",
      })
      return
    }
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Dequeue completado",
        description: `Se removió "${dequeuedValue}" del frente de la fila`,
      })
    }, 800)
  }
  ...
  const handleClear = () => {
    ...
    toast({
      title: "Fila limpiada",
      description: "Se han removido todos los elementos de la fila",
    })
  }
