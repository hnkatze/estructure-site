...
export default function ArrayVisualization({ initialArray = [5, 12, 8, 3, 17, 9] }: ArrayVisualizationProps) {
  ...
  const handleSearch = () => {
    ...
    if (isNaN(value)) {
      toast({
        title: "Valor inválido",
        description: "Por favor ingresa un número válido para buscar",
        variant: "destructive",
      })
      return
    }
  ...
  return (
    <div className="space-y-6 p-4 bg-card rounded-lg w-[70%] ">
      ...
      <div className="flex flex-wrap gap-2 items-center">
        ...
        {array.length === 0 && <div className="text-muted-foreground italic">Arreglo vacío</div>}
      </div>
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="flex gap-2">
            <Input
              ...
              disabled={isAnimating}
            />
            <Button onClick={handleAddElement} disabled={isAnimating || !newValue}>
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="flex gap-2">
            <Input
              ...
              disabled={isAnimating}
            />
            <Button onClick={handleSearch} disabled={isAnimating || !searchValue} variant="secondary">
