  ...
  const handleInsert = () => {
    if (!key.trim() || !value.trim()) {
      toast({
        ...
        description: "Por favor ingresa una clave y un valor",
        variant: "destructive",
      })
      return
    }
    ...
    if (existingIndex !== -1) {
      toast({
        ...
        description: `La clave "${key}" ya existe. Usa la operación de actualización.`,
        variant: "destructive",
      })
      return
    }
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        toast({
          ...
          description: `Se ha insertado la clave "${key}" con valor "${value}"`,
        })
      }, 1000)
    }, 500)
  }
  ...
  const handleSearch = () => {
    if (!searchKey.trim()) {
      toast({
        ...
        description: "Por favor ingresa una clave para buscar",
        variant: "destructive",
      })
      return
    }
      ...
      if (implementationType === "object") {
        ...
        if (foundIndex !== -1) {
          ...
          toast({
            ...
            description: `Valor para la clave "${searchKey}": "${entries[foundIndex].value}"`,
          })
        } else {
          toast({
            title: "Entrada no encontrada",
            description: `No se encontró la clave "${searchKey}"`,
            variant: "destructive",
          })
        }
      } else {
        ...
        if (foundEntry) {
          ...
          toast({
            title: "Entrada encontrada",
            description: `Valor para la clave "${searchKey}": "${foundEntry.value}"`,
          })
        } else {
          toast({
            title: "Entrada no encontrada",
      ...
      if (index !== -1) {
        ...
        setTimeout(() => {
          ...
          toast({
            ...
            description: `Se ha eliminado la clave "${entryKey}"`,
          })
        }, 500)
      }
    }, 500)
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        toast({
          ...
          description: `Se ha actualizado el valor de "${entryKey}" a "${editValue}"`,
        })
      }, 500)
    }, 500)
  }
