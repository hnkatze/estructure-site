...
export default function TreeVisualization({ initialTree = [50, 30, 70, 20, 40, 60, 80] }: TreeVisualizationProps) {
  ...
  const handleInsert = () => {
    ...
    if (root && searchNode(root, value)) {
      toast({
        ...
        description: `El valor ${value} ya existe en el árbol`,
        variant: "destructive",
      })
      return
    }
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `Se ha insertado el valor ${value} en el árbol`,
      })
    }, 800)
  }
  ...
  const handleRemove = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `Se ha eliminado el valor ${value} del árbol`,
      })
    }, 800)
  }
  ...
  const handleSearch = () => {
    ...
    setTimeout(() => {
      if (found) {
        toast({
          title: "Nodo encontrado",
          description: `El valor ${value} existe en el árbol`,
        })
      } else {
        toast({
          title: "Nodo no encontrado",
