...
const LinkedListVisualization: React.FC = () => {
  ...
  const handleInsertAtBeginning = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Nodo insertado",
        description: `Se ha insertado el valor ${value} al inicio de la lista`,
      })
    }, 800)
  }
  ...
  const handleInsertAtEnd = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Nodo insertado",
        description: `Se ha insertado el valor ${value} al final de la lista`,
      })
    }, 800)
  }
  ...
  const handleInsertAfter = () => {
    ...
    if (targetIndex === -1) {
      toast({
        ...
        description: "El valor objetivo no existe en la lista",
        variant: "destructive",
      })
      return
    }
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Nodo insertado",
        description: `Se ha insertado el valor ${value} después de ${target}`,
      })
    }, 800)
  }
  ...
  const handleDelete = (value: number) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `Se ha eliminado el valor ${value} de la lista`,
      })
    }, 800)
  }
